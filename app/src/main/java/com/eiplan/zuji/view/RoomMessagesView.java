...
public class RoomMessagesView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        editview = (EditText) findViewById(R.id.et_chat_msg);
        iv_send = findViewById(R.id.iv_send);
        closeView = (ImageView) findViewById(R.id.close);
        sendContainer = findViewById(R.id.container);
    ...
    private class ListAdapter extends RecyclerView.Adapter<MyViewHolder> {
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            ...
            if (message.getBody() instanceof EMTextMessageBody) {
                if (message.getFrom().equals("15988817032")) {
                    holder.name.setText("宋柯");
                } else if (message.getFrom().equals("13627807142")) {
                ...
                if (EMClient.getInstance().getCurrentUser().equals(message.getFrom())) {
                    holder.content.setTextColor(getResources().getColor(R.color.system_blue));
                } else {
                    holder.content.setTextColor(getResources().getColor(R.color.color_white));
                }
