...
//                continue;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ll1:
                mContext.startActivity(new Intent(mContext,ReleaseDocActivity.class));
                dismiss();
                break;
            case R.id.ll2:
                ...
                break;
            case R.id.ll3:
                mContext.startActivity(new Intent(mContext,RecommendMSGActivity.class));
                dismiss();
                break;
            case R.id.ll4:
                mContext.startActivity(new Intent(mContext,ReleaseProblemActivity.class));
                dismiss();
                break;
            case R.id.ll5:
                mContext.startActivity(new Intent(mContext,ReleaseDemandActivity.class));
                dismiss();
                break;
            case R.id.ll6:
