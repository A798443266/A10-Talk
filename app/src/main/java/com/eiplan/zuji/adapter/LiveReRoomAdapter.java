...
public class LiveReRoomAdapter extends BaseAdapter {

    private List<ReLiveRoom> rooms;
    private Context context;

    public LiveReRoomAdapter(List<ReLiveRoom> rooms, Context context) {
        this.rooms = rooms;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if(convertView == null){
            convertView = View.inflate(context,R.layout.relive_room,null);
