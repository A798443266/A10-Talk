package com.eiplan.zuji.single;
...
public class VideoCallActivity extends CallActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_call1);
    ...
    protected void initView() {
        getAllChildViews(getWindow().getDecorView(), 1);

        littleWidth = UIUtils.dp2px(96);
        littleHeight = UIUtils.dp2px(128);
        rightMargin = UIUtils.dp2px(16);
        topMargin = UIUtils.dp2px(96);
...
//            CallManager.getInstance().closeSpeaker();
    ...
    private void onRecordCall() {
        ...
        if (recordSwitch.isActivated()) {
            ...
            if (file.exists()) {
                Toast.makeText(this, "录制视频成功 " + path, Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(this, "录制失败/(ㄒoㄒ)/~~", Toast.LENGTH_LONG).show();
            }
        } else {
            // 设置按钮状态
...
//            VMLog.d("开始录制视频");
    ...
    private void onScreenShot() {
        String dirPath = Environment.getExternalStorageDirectory() + "videos/";
        File dir = new File(dirPath);
        if (!dir.isDirectory()) {
            dir.mkdirs();
        }
        ...
        Toast.makeText(this, "拍照保存成功 " + path, Toast.LENGTH_LONG).show();
    ...
    private void initCallSurface() {
        // 初始化显示远端画面控件
        oppositeSurface = new EMCallSurfaceView(this);
        ...
        // 初始化显示本地画面控件
        localSurface = new EMCallSurfaceView(this);
...
//            onFinish();
        ...
        case NETWORK_DISCONNECTED:
            Toast.makeText(VideoCallActivity.this, "对方网络断开", Toast.LENGTH_SHORT).show();
//            VMLog.i("对方网络断开");
            break;
        case NETWORK_NORMAL:
//            VMLog.i("网络正常");
...
//                VMLog.i("网络不稳定" + callError);
            ...
            break;
        case VIDEO_PAUSE:
            Toast.makeText(VideoCallActivity.this, "对方已暂停视频传输", Toast.LENGTH_SHORT).show();
//            VMLog.i("对方已暂停视频传输");
            break;
        case VIDEO_RESUME:
            Toast.makeText(VideoCallActivity.this, "对方已恢复视频传输", Toast.LENGTH_SHORT).show();
//            VMLog.i("对方已恢复视频传输");
            break;
        case VOICE_PAUSE:
            Toast.makeText(VideoCallActivity.this, "对方已暂停语音传输", Toast.LENGTH_SHORT).show();
//            VMLog.i("对方已暂停语音传输");
            break;
        case VOICE_RESUME:
            Toast.makeText(VideoCallActivity.this, "对方已恢复语音传输", Toast.LENGTH_SHORT).show();
//            VMLog.i("对方已恢复语音传输");
            break;
        default:
            break;
