package com.eiplan.test.palette;
...
public class PaletteActivity extends AppCompatActivity implements View.OnClickListener, PaletteView.Callback,Handler.Callback {
            ...
            case R.id.save:
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (savedFile != null) {
                            scanFile(PaletteActivity.this, savedFile);
