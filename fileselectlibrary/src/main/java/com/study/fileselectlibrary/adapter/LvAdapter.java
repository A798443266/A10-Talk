...
//                        into(iv);
                ...
                switch (adapterType) {
                    case AUDIO:
                        iv.setBackgroundResource(R.drawable.jmui_audio);
...
//                        iv.setImageURI(Uri.fromFile(new File(fileItem.getPath())));
                        iv.setBackgroundResource(R.drawable.icon_video);
                        break;
                    default:
...
//                        iv.setImageURI(Uri.fromFile(new File(fileItem.getPath())));
    ...
    private void setImageIconByName(String filename,ImageView iv) {
        ...
        switch (name) {
            case ".docx":
            case ".doc":
                iv.setBackgroundResource(R.drawable.type_doc);
                break;
            case ".pdf":
            iv.setBackgroundResource(R.drawable.type_ppt);
            break;
            case ".xlsx":
                iv.setBackgroundResource(R.drawable.type_exe);
                break;
            default:
                break;
        }
